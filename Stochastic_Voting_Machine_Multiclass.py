...
Num_Replicas=21 #Number of Replicas
v=150 #Number of Anchor Points
...
for train_index, test_index in kf:
    ...
    for i in range(0,Num_Replicas):
        ...
        for j in range(0,m_test):
            Predicted_ValuesG[i][j]=round2(Predicted_ValuesG[i][j])
            Predicted_ValuesE[i][j]=round2(Predicted_ValuesE[i][j])
            Predicted_ValuesER[i][j]=round2(Predicted_ValuesER[i][j])
            Predicted_ValuesA[i][j]=round2(Predicted_ValuesA[i][j])
            Predicted_ValuesF[i][j]=round2(Predicted_ValuesF[i][j])
